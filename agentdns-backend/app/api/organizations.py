...
def delete_organization(
    ...
    if services:
        from ..models.review import ServiceTrustStats, ServiceReview
        for service in services:
            ...
            db.query(ServiceReview).filter(ServiceReview.service_id == service.id).delete()
            db.query(ServiceTrustStats).filter(ServiceTrustStats.service_id == service.id).delete()
            from ..models.service import ServiceMetadata
            db.query(ServiceMetadata).filter(ServiceMetadata.service_id == service.id).delete()
            db.delete(service)
