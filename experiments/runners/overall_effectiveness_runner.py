...
DEFAULT_OUTPUT_DIR = ROOT / 'outputs' / 'sample' / 'overall_effectiveness_results'
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='运行整体有效性实验。')
    parser.add_argument('--experiment-id', default='overall_effectiveness')
...
def main() -> None:
    ...
    for offset, group_id in enumerate(experiment['group_ids']):
        ...
        print(f'已完成整体有效性实验组别：{group_name}')
