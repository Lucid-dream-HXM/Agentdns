...
2. 从 b2_hard_inclass_deception_market_v1/service_catalog.json 重新导入服务
...
def main():
    CATALOG_PATH = '/home/hxm/projects/AgentDNS/experiments/outputs/b2_hard_inclass_deception_market_v1/service_catalog.json'
    ORG_ID = 1
